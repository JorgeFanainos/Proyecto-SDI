...
const stripePromise = loadStripe(
  "pk_test_51JoFN9BABNlqbpwmwzuZ8jpi4kOJcKRShDKR5aqPsG5n3cJuCtzLJzDygVE49LIARvlciux4WG6CgHxKPgd2XMFL00XqWb04d8"
);
const CheckoutForm = () => {
    ...
    <form className="ContenedorTodo" onSubmit={handleSubmit}>
      <div className="contenedorPagos">
        ...
        <div className="inputspago">
          ...
          <input type="text" placeholder="Jhon Doe" variant="filled" required />
        </div>
